...
--combined departure and arrival into one table called flights
...
VALUES
  ...
  ('2018-01-02 07:00:00', '2018-01-02 08:03:00', 3, 'Los Angeles', 'United States', 'Las Vegas', 'United States'), --LA/Seattle both use Delta so same airlines_id value
...
--reduce redundancy, what information is unique to a particular data set take that and turn it into separate tables 